...
class StyleViewController: BaseViewController, DataReloadDelegate {
    ...
    override func constraintLayout() {
        [logo, styleTitle, styleImage, styleDetail, temperature, clothesIcon].forEach(){
            view.addSubview($0)
        }
        ...
        clothesIcon.snp.makeConstraints(){
            $0.top.equalTo(styleDetail.snp.bottom).offset(-30)
            $0.centerX.equalTo(view)
            $0.horizontalEdges.equalTo(view).inset(96)
        }
        temperature.snp.makeConstraints(){
            $0.top.equalTo(styleImage.snp.bottom).offset(100)
            $0.centerX.equalTo(view)
        }
    }
    ...
    func updateTextBasedOnTemperature(for temperatureNow: String) {
        ...
        if let temperature = Int(temperatureNow) {
            ...
            case 15..<20:
                ...
                clothesIconImage = UIImage(named: "15")!
            case 20..<23:
    ...
    override func configureUI() {
        ...
        clothesIcon.contentMode = .scaleAspectFit
